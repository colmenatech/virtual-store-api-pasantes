   ...
   /* public function __construct()
    ...
    public function store(Request $request)
    {
        ...
        $subcategory = Subcategory::create([
            'name' => $request->NameSub, // Asegúrate de que el campo sea el mismo que en tu solicitud
            'category_id' => $request->NameCategory, //TODO se debe pasar el id de la categoria y no el nombre
        ]);
    ...
    public function update(Request $request, $id)
{
    ...
    $subcategory->update([
        'name' => $request->NameSub, //El campo nombre de subcategoria es requerido
        'category_id' => $request->NameCategory, //TODO se debe pasar el id de la categoria y no el nombre
    ]);
